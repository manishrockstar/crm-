          ...
          <h:form>       
                     ...
                     <f:facet name="header">
                         ...
                         <h:outputText value="Assign New Person"/>
                                    ...
                                    <h:selectOneMenu  value="#{perInfo.person}" valueChangeListener="#{perInfo.changeListener}" >
                                        <f:selectItems value="#{perInfo.names}" />
                         </h:selectOneMenu>
                     
                     
                     <h:panelGroup>
                         <h:commandButton value="Assign" action="#{perInfo.assignTicket(item,perInfo)}"/>
                     </h:panelGroup>
