  ...
  <a class="right carousel-control" href="#" role="button" data-slide="next">
	...
	<h:form>
                <h:panelGrid width="475px" bgcolor="#e6edfd" columns="2" border="0">
                    <f:facet name="header">
                        <h:outputText value="Ticket Details"/>
                    </f:facet>


                    <h:outputText value="SUMMARY OF ISSUE: " />					
                    <h:panelGroup>
                        <h:inputText id="name" value="#{persondetails.name}" style="width:300px" required="true">
                    ...
                    <h:inputText id="fname" value="#{persondetails.fname}" style="width:300px"/>

                    <h:outputText value="DESK NUMBER: " />
                    <h:inputText id="mname" value="#{persondetails.mname}" style="width:300px" />

                    <h:outputText value="CURRENT ISSUE: " />
                    <h:inputTextarea id="caddress" value="#{persondetails.caddress}" style="width:300px" />

                    <h:outputText value="BUSINESS JUSTIFICATION: " />
                    <h:inputTextarea id="paddress" value="#{persondetails.paddress}" style="width:300px" />
                    ...
                    <h:panelGroup>
                        <h:inputText id="phoneno" value="#{persondetails.empno}" style="width:300px" required="true"/>
                    ...
                    <h:panelGroup>
                        <h:inputText id="mobileno" value="#{persondetails.mobileno}" style="width:300px" required="true"/>
                        <f:verbatim><br/></f:verbatim>
